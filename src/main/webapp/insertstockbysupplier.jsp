...
<form id="j_idt9" name="j_idt9" method="post" action="SupplierInsertStock" class="form" enctype="multipart/form-data">
...
<input id="j_idt9:addedBy" type=hidden value="<%= supplier.getName() %>" name="addedBy" />
</div>
